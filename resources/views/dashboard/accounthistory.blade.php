            ...
            <div class="mb-5 row">
                <div class="col text-center card p-4   bg-light  ">
                    ...
                    <div class="px-3 py-3 tab-content px-sm-0" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade p-3   bg-light  " id="2" role="tabpanel"
                        ...
                        <div class="tab-pane fade p-3   bg-light  " id="3" role="tabpanel"
                    ...
                    <form role="form" method="post"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control   bg-light   text-dark" Placeholder="E.g. Standard"
