! function(global, factory) {
    ...
    function processLoadingDirective(component, el, directive) {
        ...
        if (directives.get("target")) actionNames = directives.get("target").value.split(",").map((function(s) {
            return s.trim()
        }));
        else {
            ...
            livewireEl && livewireEl.__livewire && Object.entries(component.unobservedData).forEach((function(_ref) {
                ...
                if (value && "object" === _typeof(value) && value.livewireEntangle) {
                    ...
                    component.unobservedData.$watch(key, (function(value) {
                        !0 !== blockAlpineWatcher ? value !== livewireEl.__livewire.getPropertyValueIncludingDefers(livewireProperty) && livewireComponent.set(livewireProperty, value, isDeferred, !0) : blockAlpineWatcher = !1
        ...
        function onlyChangeThePathAndQueryString(url) {
            if (url) {
                var destination = new URL(url),
                    afterOrigin = destination.href.replace(destination.origin, "");
